...
public class InitDB {
    ...
    static class InitService {
        ...
        public void dbInit2() {
            Member member = createMember("userB", "부산", "2가", "2222");
            em.persist(member);
            ...
            OrderItem orderItem1 = OrderItem.creatOrderItem(book1, 15000, 3);
            OrderItem orderItem2 = OrderItem.creatOrderItem(book2, 25000, 4);
